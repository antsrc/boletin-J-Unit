...
public class Account {
	...
	public boolean withdraw(float amount, float fee) {
		...
		/*
		 * Se ha creado la variable valid para almacenar la validez de la operación
		 * antes de modificar el valor de amount, dado que, tras esto, una
		 * recomprobación de la validez podría arrojar un resultado diferente al
		 * original, de forma que el usuario reciba una información incorrecta sobre si
	...
	private boolean isValidWithdrawl(float amount, float fee) {
		...
		// Se ha añadido la fee a la comprobación
	}
